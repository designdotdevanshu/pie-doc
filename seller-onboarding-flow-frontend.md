...
* Otherwise, click **“Create New Account”** and enter:
...
Depending on your business type, you’ll be prompted for:
...
* **Return Address** (text field with “same as pickup” checkbox)
...
* **Account Holder’s Name** (text field)
